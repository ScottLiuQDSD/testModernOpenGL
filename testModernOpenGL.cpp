// testModernOpenGL.cpp : Defines the entry point for the console application.
//
...
{
	tdogl::Bitmap bmp = tdogl::Bitmap::bitmapFromFile("F:/Demo/TestVTKDemo/testModernOpenGL/hazard.png");
	bmp.flipVertically();
